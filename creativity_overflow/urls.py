...
urlpatterns = [
    ...
    path("inventory/<int:artist_id>/", Inventory_list.as_view(), name="inventory-list"),
    path("inventory-detail/<int:pk>/", Inventory_update.as_view(), name="inventory-update"), #ma bdo front_slash belakhr
